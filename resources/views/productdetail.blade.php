    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13">
                <a rel="lightbox[portfolio]" href="{{$model->photo_link}}" title="{{$model->name}}"><img
                        src="{{$model->photo_link}}" alt="Image {{$model->id}}"/></a>
            </div>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur semper quam sit amet turpis rhoncus id
                venenatis tellus sollicitudin. Fusce ullamcorper, dolor non mollis pulvinar, turpis tortor commodo nisl,
                et semper lectus augue blandit tellus. Quisque id bibendum libero.</p>
